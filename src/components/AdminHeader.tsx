...
const AdminHeader = () => {
  ...
  return (
    <header>
      ...
      <div className="fixed top-0 left-0 w-screen h-12 bg-gradient-to-r from-blue-300 to-blue-200  flex justify-start items-center px-4 z-10">
        ...
        <div
          className="min-w-fit mr-8 hover:text-lg"
          role="button"
